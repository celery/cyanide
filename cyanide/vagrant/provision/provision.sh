...
CYANIDE_DIR="${GIT_ROOT}/cyanide"
CELERY_CONFIG_SRC="${CYANIDE_DIR}/cyanide/vagrant/provision/celeryd-init.config"
...
install_celery () {
    ...
    github_clone "${CELERY_GITHUB_USER}" celery "${CELERY_DIR}"
